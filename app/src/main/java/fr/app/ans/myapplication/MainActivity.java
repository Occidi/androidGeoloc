...
public class MainActivity extends AppCompatActivity {
    ...
    public void toggleGPSUpdates(View view) {
        ...
        myIntent.putExtra("latUsermsg", latUservalue);
        myIntent.putExtra("longUsermsg", longUservalue);
        ...
        public void onLocationChanged(Location location) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(MainActivity.this, "Mise à jour des données GPS", Toast.LENGTH_SHORT).show();
                }
            });
        }
